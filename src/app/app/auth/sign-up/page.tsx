      ...
      <div className="size-fit rounded-lg border-2 border-umuravadark/20 p-8">
        <div className="grid min-w-[600px] grid-cols-2">
          <Link href={"/auth/sign-in"}>
            <h1 className="p-4 text-center text-3xl font-bold">Sign in</h1>
          </Link>
        ...
        <div className="flex min-w-[600px] flex-col gap-4">
          <div className="space-y-2">
            ...
            <SelectNative
              id={"id"}
              className="h-16 w-full border-2 border-black/20 focus-visible:outline-none"
            >
        ...
        <Button
          className="mt-4 size-fit w-full bg-umurava p-4"
          onClick={buttonClick}
        >
          Sign in
        </Button>
